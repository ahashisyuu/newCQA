...
class BatchDatasets:
    def __init__(self,  q_max_len=None, c_max_len=None, char_max_len=16,
    ...
    def padding(self, qtext, q_len, ctext, c_len):
        ...
        return [pad_res[0], q_len, pad_res[1], c_len]

    def mini_batch_data(self, qText, q_len, cText, c_len, cate, rel, batch_size):
        ...
        for batch_start in np.arange(0, data_size, batch_size):
            ...
            yield self.padding(batch_qText, batch_q_len, batch_cText, batch_c_len) + [batch_cate, batch_rel]
